  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* --- ESTILO 1: DIVIDIDO (Nuevo Diseño Jerárquico) --- */}
        {/* Título arriba grande, dos columnas de texto abajo */}
        {alineacion === 'dividido' && (
            <div className="flex flex-col gap-10 md:gap-16">
                
                {/* 1. TÍTULO: Ocupa todo el ancho y es muy grande */}
                ...
                {/* 2. COLUMNAS DE TEXTO: Izquierda y Derecha */}
        ...
        {/* --- ESTILO 2: CENTRADO (Clásico) --- */}
        {/* Título centrado, texto centrado abajo */}
        {alineacion === 'centrado' && (
